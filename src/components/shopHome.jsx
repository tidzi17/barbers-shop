...
export default function ShopSectionHome(){
    return(
        <div className=" border-b-2 border-white py-10 overflow-hidden">
            <div className="w-full flex h-full mt-5">
            <div className='md:w-1/2 text-white mt-10 ml-7 mb-44'>
           ...
           <div className="hidden md:flex flex w-1/2 items-center mt-44  justify-around h-full pt-20">
