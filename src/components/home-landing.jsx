  ...
  useEffect(() => {
    ...
    return(
       ...
       Crafting Timeless Styles Since '95. <br></br> Discover the Expertise of Masters Barbershop.
          ...
          <button onClick={handleScroll} className='px-3 py-3 border-[1px] border-zinc-200 text-zinc-200 text-xs md:text-base'>Book Apointment</button>
      <Link to="/services"><button   className='px-3 py-3 border-[1px] border-zinc-200 text-zinc-200 text-xs md:text-base'>Our Services</button> </Link>
          </div>
        </div>
      </div>
    )
